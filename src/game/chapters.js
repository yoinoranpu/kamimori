...
export const CHAPTERS = {
  ...
  3: {
    ...
    preBoss: { kasha: 3, kitsune: 4, nurikabe: 1, kamaitachi: 1, wisp: 10 },
    turns: {
      1: { kitsune: 1, onibi: 3 },
      2: { kitsune: 2, onibi: 3 },
      3: { wisp: 10, kitsune: 2, kasha: 1 },
      4: { kitsune: 2, onibi: 6, kasha: 1 },
      5: { kasha: 1, kitsune: 3, onibi: 3 },
      6: { wisp: 16, kasha: 2, kitsune: 2 },
      7: { nurikabe: 1, kasha: 2, kitsune: 3 },
      8: { yukionna: 3, kasha: 2, kitsune: 3, wisp: 10 },
      9: { nurikabe: 1, kasha: 3, kitsune: 3, wisp: 8 },
    },
  },
}
